...
.form-signin {
  ...
  <body>
    <header>
					...
					<div class="container-fluid">
						...
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation"><a href="${pageContext.request.contextPath}/kayitOl">KAYIT OL</a></li>
								<li role="presentation"><a href="${pageContext.request.contextPath}/giris">GİRİŞ YAP</a></li>					
							</ul>
						</div>
					</div>			
				</nav>
	  ...
	  <div class="wrapper">
    <form class="form-signin" action="anaSayfa">       
